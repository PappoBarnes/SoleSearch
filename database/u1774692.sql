...
--
-- Host: localhost
-- Generation Time: Dec 02, 2018 at 09:26 PM
...
(69, 'https://www.flightclub.com/palace-indoor-ftwwht-boblue-syello-801337', 73);
...
(73, 16, 'Palace Indoor', 'Palace Skateboards celebrated the grand opening of their new retail location in New York City’s SoHo neighborhood by reconnecting with adidas Originals for another dope collab. The capsule collection arrived summer 2017, releasing exclusively at their London and NYC locales, followed by an online release. Apparel aside, the adidas Palace Indoor in two new colorways highlighted the drop.<br>\r\n\r\nManufacturer Sku	CG3364<br>\r\nGender	Mens<br>\r\nColorway	FTWWHT/BOBLUE/SYELLO<br>\r\nMaterials	Rubber, Suede<br>', 'images/palaceindoor.jpg'),
(74, 31, 'M & N Jersey', 'Inspired by the fan-favorite uniforms of the 1996 NBA All-Star Game, Shawn Kemp’s iconically bold Reebok Kamikzae II received this special colorway from Packer Shoes. It features a premium nubuck and leather upper in shades of grey and light blue with vibrant teal, pink, and orange accents from the uniforms from the San Antonio game. Release in limited quantities, this has since become one of the most popular retros of the Kamikaze II.<br>\r\n\r\nManufacturer Sku	V53621<br>\r\nNickname	AllStar<br>\r\nGender	Mens<br>\r\nColorway	STEEL/BLUE/CYCLONE GRY<br>\r\nMaterials	Multi, Rubber<br>', 'images/kamikazi.jpg');
